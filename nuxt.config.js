...
module.exports = {
  ...
  */
  ...
  head: {
    script: [
      ...
      {
        src: "jquery-jvectormap-it_regions-merc.js",
        type: "text/javascript"
      },
      {
        src: "jquery-jvectormap-it-merc.js",
        type: "text/javascript"
      }
    ],
    title: 'Covid19 Meter',
    ...
    link: [
      ...
      { rel: 'stylesheet', href: '/jquery-jvectormap.css' }
    ]
  },
  ...
  */
  ...
  proxy: {
    '/api/': development ? 'http://localhost:3000' : 'https://unisa-covid.herokuapp.com/'
  },
